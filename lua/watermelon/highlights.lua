...
hl.common = {
    ...
    MatchParen       = { bg = c.darkpink, fmt = "bold" },
    NonText          = { fg = c.fg2 },
    Whitespace       = { fg = c.fg2 },
    SpecialKey       = { fg = c.fg2 },
...
hl.langs.css = {
    ["@attribute.css"]         = { fg = c.green },
    ["@character.special.css"] = { fg = c.white },
    ["@function.css"]          = { fg = c.darkgreen },
    ["@keyword.import.css"]    = { fg = c.red, fmt = "bold" },
    ["@property.css"]          = { fg = c.yellow },
    ["@string.css"]            = { fg = c.green },
    ["@tag.css"]               = { fg = c.white },
    ["@tag.attribute.css"]     = { fg = c.darkgreen },
    ["@type.css"]              = { fg = c.white },
    ["@value.css"]             = { fg = c.lightblue, fmt = "bold" },
}

hl.langs.html = {
    ["@comment.html"]            = { fg = c.fg2 },
    ["@constant.html"]           = { fg = c.red },
    ["@markup.heading.html"]     = { fg = c.white },
    ["@none.html"]               = { fg = c.white },
    ["@string.html"]             = { fg = c.green },
    ["@string.special.url.html"] = { fg = "" },
    ["@tag.html"]                = { fg = c.red },
    ["@tag.attribute.html"]      = { fg = c.darkgreen },
}

hl.langs.javascript = {
    ["@function.javascript"]             = { fg = c.red },
    ["@function.method.call.javascript"] = { fg = c.darkgreen },
    ["@keyword.conditional.javascript"]  = { fg = c.red, fmt = "bold" },
    ["@keyword.coroutine.javascript"]    = { fg = c.limegreen },
    ["@keyword.function.javascript"]     = { fg = c.darkgreen },
    ["@keyword.repeat.javascript"]       = { fg = c.red, fmt = "bold" },
    ["@punctuation.bracket.javascript"]  = { fg = c.white },
    ["@variable.javascript"]             = { fg = c.green },
        ...
        if color_name:sub(1, 1) == '$' then
            ...
            if not color_name then
                vim.schedule(function()
                    vim.notify('watermelon.nvim: unknown color "' .. name .. '"', vim.log.levels.ERROR,
                        { title = "watermelon.nvim" })
                end)
                return ""
            end
        end
